output "data_factory_linked_service_azure_sql_databases_id" {
  ...
  value       = { for k, v in azurerm_data_factory_linked_service_azure_sql_database.data_factory_linked_service_azure_sql_databases : k => v.id if v.id != null && length(v.id) > 0 }
}
output "data_factory_linked_service_azure_sql_databases_additional_properties" {
  ...
  value       = { for k, v in azurerm_data_factory_linked_service_azure_sql_database.data_factory_linked_service_azure_sql_databases : k => v.additional_properties if v.additional_properties != null && length(v.additional_properties) > 0 }
}
output "data_factory_linked_service_azure_sql_databases_annotations" {
  ...
  value       = { for k, v in azurerm_data_factory_linked_service_azure_sql_database.data_factory_linked_service_azure_sql_databases : k => v.annotations if v.annotations != null && length(v.annotations) > 0 }
}
output "data_factory_linked_service_azure_sql_databases_connection_string" {
  ...
  value       = { for k, v in azurerm_data_factory_linked_service_azure_sql_database.data_factory_linked_service_azure_sql_databases : k => v.connection_string if v.connection_string != null && length(v.connection_string) > 0 }
}
output "data_factory_linked_service_azure_sql_databases_credential_name" {
  ...
  value       = { for k, v in azurerm_data_factory_linked_service_azure_sql_database.data_factory_linked_service_azure_sql_databases : k => v.credential_name if v.credential_name != null && length(v.credential_name) > 0 }
}
output "data_factory_linked_service_azure_sql_databases_data_factory_id" {
  ...
  value       = { for k, v in azurerm_data_factory_linked_service_azure_sql_database.data_factory_linked_service_azure_sql_databases : k => v.data_factory_id if v.data_factory_id != null && length(v.data_factory_id) > 0 }
}
output "data_factory_linked_service_azure_sql_databases_description" {
  ...
  value       = { for k, v in azurerm_data_factory_linked_service_azure_sql_database.data_factory_linked_service_azure_sql_databases : k => v.description if v.description != null && length(v.description) > 0 }
}
output "data_factory_linked_service_azure_sql_databases_integration_runtime_name" {
  ...
  value       = { for k, v in azurerm_data_factory_linked_service_azure_sql_database.data_factory_linked_service_azure_sql_databases : k => v.integration_runtime_name if v.integration_runtime_name != null && length(v.integration_runtime_name) > 0 }
}
output "data_factory_linked_service_azure_sql_databases_key_vault_connection_string" {
  ...
  value       = { for k, v in azurerm_data_factory_linked_service_azure_sql_database.data_factory_linked_service_azure_sql_databases : k => one(v.key_vault_connection_string) if v.key_vault_connection_string != null && length(v.key_vault_connection_string) > 0 }
}
output "data_factory_linked_service_azure_sql_databases_key_vault_password" {
  ...
  value       = { for k, v in azurerm_data_factory_linked_service_azure_sql_database.data_factory_linked_service_azure_sql_databases : k => one(v.key_vault_password) if v.key_vault_password != null && length(v.key_vault_password) > 0 }
}
output "data_factory_linked_service_azure_sql_databases_name" {
  ...
  value       = { for k, v in azurerm_data_factory_linked_service_azure_sql_database.data_factory_linked_service_azure_sql_databases : k => v.name if v.name != null && length(v.name) > 0 }
}
output "data_factory_linked_service_azure_sql_databases_parameters" {
  ...
  value       = { for k, v in azurerm_data_factory_linked_service_azure_sql_database.data_factory_linked_service_azure_sql_databases : k => v.parameters if v.parameters != null && length(v.parameters) > 0 }
}
output "data_factory_linked_service_azure_sql_databases_service_principal_id" {
  ...
  value       = { for k, v in azurerm_data_factory_linked_service_azure_sql_database.data_factory_linked_service_azure_sql_databases : k => v.service_principal_id if v.service_principal_id != null && length(v.service_principal_id) > 0 }
}
output "data_factory_linked_service_azure_sql_databases_service_principal_key" {
  ...
  value       = { for k, v in azurerm_data_factory_linked_service_azure_sql_database.data_factory_linked_service_azure_sql_databases : k => v.service_principal_key if v.service_principal_key != null && length(v.service_principal_key) > 0 }
}
output "data_factory_linked_service_azure_sql_databases_tenant_id" {
  ...
  value       = { for k, v in azurerm_data_factory_linked_service_azure_sql_database.data_factory_linked_service_azure_sql_databases : k => v.tenant_id if v.tenant_id != null && length(v.tenant_id) > 0 }
}
output "data_factory_linked_service_azure_sql_databases_use_managed_identity" {
  ...
  value       = { for k, v in azurerm_data_factory_linked_service_azure_sql_database.data_factory_linked_service_azure_sql_databases : k => v.use_managed_identity if v.use_managed_identity != null }
}
